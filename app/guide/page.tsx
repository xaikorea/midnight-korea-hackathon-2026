...
export default function GuidePage(){return <main className="guide-public" id="guide-top"><header><a href="/">BizProof<span> · 워크스페이스로</span></a><h1>이용자 가이드</h1><p>로그인 없이 읽고, 필요한 기능으로 바로 이동하세요.</p></header><UserGuide/></main>;}
