...
const tests=['independent-issuer.cjs','process-animation.cjs','admin-password.cjs','review-fixes.cjs','supplier-visibility.cjs','lei-directory.cjs','portable-credential.cjs','vlei-verifier.cjs','waltid-verifier.cjs','keycloak.cjs','openbao.cjs','jsonforms.cjs','ajv-validation.cjs','opa.cjs','openfga.cjs','openfga-api.cjs','malware-scan.cjs','malware-api.cjs','keria.cjs','business-enforcement.cjs','midnight-source.cjs','visitor-analytics.cjs','visitor-analytics-expanded.cjs','application-flow.cjs','application-batch.cjs','application-process.cjs','demo-pool.cjs','workflow-exceptions.cjs','review-20260922-probes.cjs'];
tests.push('midnight-evidence.cjs','blockchain-visualization.cjs','proof-jobs.cjs','identity-provider.cjs','identity-browser.cjs','proof-job-progress.cjs','proof-worker-loop.mjs');
tests.push('policy-reference.cjs','compact-policy.cjs','program-applications.cjs','program-api.cjs','program-proof-jobs.cjs');
tests.push('demo-automation.cjs','demo-issuance-automation.cjs');
