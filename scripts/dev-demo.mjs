...
const directory=resolve('outputs/local-web-demo');mkdirSync(directory,{recursive:true,mode:0o700});
...
console.log('Synthetic local demo: '+env.BIZPROOF_APP_ORIGIN+' (private state stays in outputs/local-web-demo)');
