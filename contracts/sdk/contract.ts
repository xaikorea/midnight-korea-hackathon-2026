...
import {Contract,type BusinessClaims,type Schnorr_SchnorrSignature,type Witnesses} from '../managed/contract/index.js';
import {assetsDirectory} from './config.ts';
...
export const compiledContract=CompiledContract.make<BusinessContract>('BizProof',Contract).pipe(CompiledContract.withWitnesses(witnesses),CompiledContract.withCompiledFileAssets(assetsDirectory));
